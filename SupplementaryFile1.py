# -*- coding: utf-8 -*-
"""
Supplementary File 1 - Orb2 ODE aggregation model
...
Parameters = (nu, dc, T_sigma, alpha_tr_RNA, Bs_th, alpha_ex, alpha_deg,
...
def f(y, t, *varargs):
    ...
    if t<=T_sigma:
        dAdt = alpha_tr_RNA * (sqw.square(2*np.pi*nu*t,duty=dc)+1)/2 * 1/np.sqrt(1
